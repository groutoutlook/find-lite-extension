FindLite.panel = {
	...
	loadAllElements: function () {
		...
		FindLite.panel.element.container = document.getElementById(
			"find-lite-container",
		);
		FindLite.panel.element.searchField = document.getElementById(
			"find-lite-search-field",
		);
		FindLite.panel.element.searchIndexText = document.getElementById(
			"find-lite-index-text",
		);
		FindLite.panel.element.caseSensitiveButton = document.getElementById(
			"find-lite-case-sensitive",
		);
		FindLite.panel.element.wholeWordButton = document.getElementById(
			"find-lite-whole-word",
		);
		FindLite.panel.element.regexButton =
			document.getElementById("find-lite-regex");
		FindLite.panel.element.previousButton =
			document.getElementById("find-lite-previous");
		FindLite.panel.element.nextButton =
			document.getElementById("find-lite-next");
		FindLite.panel.element.exitButton =
			document.getElementById("find-lite-exit");
		FindLite.panel.element.sidebar =
			document.getElementById("find-lite-sidebar");
		FindLite.panel.element.highlightLineX = document.getElementById(
			"find-lite-highlight-line-x",
		);
		FindLite.panel.element.highlightLineY = document.getElementById(
	...
	appendCSS: async function () {
		...
		let rawCSS = await fetch(chrome.runtime.getURL("content/content.css")).then(
	...
	isCaseSensitive: function () {
		return FindLite.panel.element.caseSensitiveButton.classList.contains(
			"active",
		);
	},
